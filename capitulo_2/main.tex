...
Esse princípio pode ser generalizado para mais de dois lugares. Aplicando o axioma de Bayes recursivamente, o ccdf N-variado pode ser escrito como o produto de N ccdfs univariados da seguinte forma \cite{goovaerts1997geostatistics}:
...
\subsubsection{Simulação geostatística multi-ponto}
