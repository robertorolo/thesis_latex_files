...
\begin{figure}[H]
    \caption{Exemplo mostrando a extração da isosuperfície zero e visualização em três dimensões.} \label{implicit_3d_ex}
     ...
     \subfloat[][Modelo implícito interpolado por RBF para a categoria sendo modelada.]{\includegraphics[width=.5\textwidth]{capitulo_2/imagens/rbf.jpeg}\label{fig:c2}}
     \subfloat[][Isosuperfície zero extraída a partir do modelo implícito.]{\includegraphics[width=.5\textwidth]{capitulo_2/imagens/isorbf.jpeg}\label{fig:c3}}
\end{figure}
