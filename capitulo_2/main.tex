...
\subsection{Krigagem dos indicadores (IK)}\label{ik}
...
\begin{figure}[H]
	...
	\subfloat[][Vista 1.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/one1.png}\label{<figure1>}}
	\hspace{1em}
	\subfloat[][Vista 2.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/one2.png}\label{<figure2>}}
	\hspace{1em}
	\subfloat[][Vista 3.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/one3.png}\label{<figure3>}}
\end{figure}
...
\begin{figure}[H]
    \caption{Exemplo mostrando a extração da isosuperfície zero e visualização em três dimensões.} \label{implicit_3d_ex}
     ...
     \hspace{1em}
     \subfloat[][Isosuperfície zero extraída a partir do modelo implícito.]{\includegraphics[width=.45\textwidth]{capitulo_2/imagens/isorbf.jpeg}\label{fig:c3}}
\end{figure}
...
\citeonline{silva2015enhanced} propuseram, uma adaptação para o método com o objetivo de modelar múltiplos domínios geológicos simultaneamente, de forma similar ao caso binário.
...
\begin{figure}[H]
	...
	\includegraphics[width=\textwidth]{capitulo_2/imagens/multicategoryimplicitmodeling.png}
\end{figure}
...
\begin{figure}[H]
	...
	\subfloat[][Vista 1.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/multi1.png}\label{<figure1>}}
	\hspace{1em}
	\subfloat[][Vista 2.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/multi2.png}\label{<figure2>}}
	\hspace{1em}
	\subfloat[][Vista 3.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/multi3.png}\label{<figure3>}}
\end{figure}
...
\subsubsection{Simulação sequencial dos indicadores (SISIM)}
...
\begin{figure}[H]
    ...
    \caption{Distâncias transformadas em probabilidades para a categoria Quaternary usando valores diferentes para $\omega$.} \label{jura_prob}
     \subfloat[][$\omega = 10$.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/probs_100.png}\label{<figure1>}}
     \hspace{1em}
     \subfloat[][$\omega = 100$]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/probs_1000.png}\label{<figure2>}}
     \hspace{1em}
     \subfloat[][$\omega = $ maior módulo entre as distâncias estimadas.]{\includegraphics[width=.3\textwidth]{capitulo_2/imagens/probs_00.png}\label{<figure3>}}
\end{figure}
...
Uma curva como a da \autoref{c_calib_grafico} é construída. São escolhidos N valores para C entre zero e um valor definido pelo usuário. Para cada um desses valores de C, são removidos X\% dos furos (ou amostras em duas dimensões) Z vezes. É indicado que a classificação errônea seja calculada diversas vezes para que a calibração de C seja robusta \cite{wilde2012kriging}. O índice de classificação errônea, para cada valor de C e para cada uma das frações removidas, é registrado no eixo Y do gráfico (letras X em azul) e o valor de C no eixo X. Então traça-se a classificação errônea média (curva tracejada).

\begin{figure}[H]
	\caption{\label{c_calib_grafico}Ilustração esquemática da curva de calibração.}
	\centering
		\includegraphics[width=0.8\textwidth]{capitulo_2/imagens/curva_calib.png}
\end{figure}
