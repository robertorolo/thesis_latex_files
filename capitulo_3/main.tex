...
\begin{figure}[H]
    \caption{Comparativo de seções verticais xz entre a metodologia proposta, a SISIM e um modelo explícito.} \label{sec_comp}
     ...
     \\
     \subfloat[][SISIM - MAPS.]{\includegraphics[width=0.8\textwidth]{capitulo_3/imagens/bl_sis.png}\label{fig:blsis}}
\end{figure}
...
\begin{figure}[H]
	\centering
	\label{cobre_reals}
	\caption{ Visão em perspectiva de seções verticais e horizontais de duas realizações do modelo geológico juntamente com as amostras em suporte pontual.}
...
\begin{figure}[H]
    \caption{Seções equidistantes em XZ comparando uma realização do modelo geológico do SISIM com uma realização da metodologia proposta.} \label{fig:cs_reals}
     \centering
     \subfloat[][SISIM.]{\includegraphics[width=0.5\textwidth]{capitulo_3/imagens/cp_sisim_real_0.png}\label{fig:sisimsec}}
     \\
     \subfloat[][SISIM - MAPS.]{\includegraphics[width=0.5\textwidth]{capitulo_3/imagens/bl_real.png}\label{fig:bl_real_maps}}
     \\
     \subfloat[][Simulação hierárquica de contatos.]{\includegraphics[width=0.5\textwidth]{capitulo_3/imagens/real_0.png}\label{fig:r2cp}}
\end{figure}
