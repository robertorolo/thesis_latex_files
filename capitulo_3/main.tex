...
A aplicação do método, no banco de dados \textit{Swiss Jura}, consiste em calcular as distâncias assinaladas para cada uma das cinco categorias do banco de dados. Os parâmetros para modificação do suporte devem ser escolhidos. Nesse caso usou-se um modelo linear com valor de f mínimo igual a 0.95 para todas as categorias. A \autoref{quater_param} mostra as distâncias assinaladas para a categoria Quaternary interpoladas para o cenário pessimista, caso base e cenário otimista. Os mesmos cenários foram interpolados para as outras quatro categorias presentes no banco de dados.
